// stolen from wordpress, hehe. modified a little.
// ozimodo is robin hood for the blogging community!
...
function edShowButton(button, i) {
  switch(button.id)
  {
    ...
    break
  	case 'ed_ul':
  	  document.write('<input type="button" id="' + button.id + '" accesskey="' + button.access + '" class="ed_button" onclick="edInsertTag(edCanvas, ' + i + ');" value="' + button.display + '"  /><br />')
  	break
  	default:
